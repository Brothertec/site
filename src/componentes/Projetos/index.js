                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-4 mb-4">
                        <Card imagem={cardImgAbcPublica}
                            ...
                            titulo="ABCPública"
                            texto="Novo Portal da Associação Brasileira de Comunicação Pública. Destaque para espaço de notícias, Biblioteca Digital, Mapa da Regulamentação e tema majoritariamente acessível. Design: Tema + Figma. Principais tecnologias: WordPress com CPTs, WooCommerce, PHP, MySQL, HTML, CSS, JS."
